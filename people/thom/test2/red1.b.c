...
********/
  ...
  for (forall_i0[0]=0; forall_i0[0]<0+9; forall_i0[0]++) {
    ...
    shift=temp1+0*7+0;
    offset0=_in1+forall_i0[0+0]*21+0*7+0;
    for (i1=0; i1<3; i1++) {
      for (i2=0; i2<7; i2++) {
        *(shift)= *(offset0);
        offset0+=1;
...
********/
  ...
  for (forall_i1[0]=0; forall_i1[0]<0+7; forall_i1[0]++) {
    ...
    shift=temp2+0*7+0;
    offset0=_in1+(forall_i1[0+0]+2)*21+0*7+0;
    for (i1=0; i1<3; i1++) {
      for (i2=0; i2<7; i2++) {
        *(shift)= *(offset0);
        offset0+=1;
...
********/
  ...
  for (forall_i2[0]=0; forall_i2[0]<0+5; forall_i2[0]++) {
    ...
    shift=temp3+0*8+0;
    offset0=_in2+1*240+forall_i2[0+0]*48+0*8+0;
    for (i2=0; i2<6; i2++) {
      for (i3=0; i3<8; i3++) {
        *(shift)= *(offset0);
        offset0+=1;
...
********/
  ...
  for (forall_i3[0]=0; forall_i3[0]<0+2; forall_i3[0]++) {
    ...
    offset0=_in2+forall_i3[0+0]*240+0*48+0*8+0;
    for (i1=0; i1<2; i1++) {
      for (i2=0; i2<6; i2++) {
        for (i3=0; i3<8; i3++) {
          *(shift)= *(offset0);
...
test_red2(double _in1[],double _in2[],double _out1[],double _out2[],double _out3[])
  ...
  scalar0=((1)/(21));
  scalar1=((forall_i2[0+0])/(21));
  scalar2=((forall_i2[0+0])/(21));
  scalar3=((forall_i2[0+0]+1)/(21));
/*******
out1=
********/
  ...
  for (forall_i0[0]=0; forall_i0[0]<0+2; forall_i0[0]++) {
    ...
    shift=temp5+0*7+0;
    offset0=_in2+forall_i0[0+0]*21+0*7+0;
    for (i1=0; i1<3; i1++) {
      for (i2=0; i2<7; i2++) {
        *(shift)+= *(offset0);
        offset0+=1;
...
********/
  ...
  for (forall_i1[0]=0; forall_i1[0]<0+11; forall_i1[0]++) {
    ...
    shift=temp6+0*7+0;
    offset0=_in1+(min(forall_i1[0+0],9))*21+0*7+0;
    for (i0=0; i0<(min(1,(9)-(min(forall_i1[0+0],9)))); i0++) {
      for (i1=0; i1<3; i1++) {
        for (i2=0; i2<7; i2++) {
          *(shift)= *(offset0);
          offset0+=1;
    ...
    shift=temp6+(min(1,(9)-(min(forall_i1[0+0],9))))*7+0;
    offset0=_in2+((forall_i1[0+0])-(min(forall_i1[0+0],9)))*21+0*7+0;
    for (i0=0; i0<((1)-(min(1,(9)-(min(forall_i1[0+0],9))))); i0++) {
      for (i1=0; i1<3; i1++) {
        for (i2=0; i2<7; i2++) {
          *(shift)= *(offset0);
          offset0+=1;
...
********/
  ...
  *(shift)= 1.000000;
  for (forall_i2[0]=0; forall_i2[0]<0+42; forall_i2[0]++) {
    ...
    shift=temp7+0;
    offset0=_in2+scalar1*21+0*7+0;
    for (i0=0; i0<scalar0; i0++) {
      for (i1=0; i1<3; i1++) {
        for (i2=0; i2<7; i2++) {
          *(shift)= *(offset0);
          offset0+=1;
